...
class ExchangePointTest {
    ...
    void shouldntAcceptNegativeSpread() {
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> new ExchangePoint(BigDecimal.valueOf(-1), ratesProvider));
        assertThat(thrown.getMessage(), is ("Spread -1 is illegal! Spread must be positive!"));
    }

    @Test
    void shouldntAcceptSpreadEqualTo1() {
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> new ExchangePoint(BigDecimal.ONE, ratesProvider));
        assertThat(thrown.getMessage(), is("Spread 1 is illegal! Spread must be smaller than 1!"));
    }

    @Test
    void shouldntAcceptSpreadBiggerThan1() {
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> new ExchangePoint(BigDecimal.TEN, ratesProvider));
